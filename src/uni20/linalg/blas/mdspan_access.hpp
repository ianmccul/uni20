...
concept blas_readable_device_mdspan =
    uni20::RankedStridedDeviceMdspanLike<Mdspan, Rank> &&
...
concept blas_readable_mdspan =
    uni20::RankedStridedMdspanLike<Mdspan, Rank> && blas_readable_device_mdspan<Mdspan, Rank>;

template <class Mdspan, std::size_t Rank>
concept blas_writable_device_mdspan =
    uni20::MutableRankedStridedDeviceMdspanLike<Mdspan, Rank> &&
    uni20::BlasScalar<std::remove_cv_t<typename std::remove_cvref_t<Mdspan>::element_type>> &&
    uni20::is_default_accessor_v<typename std::remove_cvref_t<Mdspan>::accessor_type>;

template <class Mdspan, std::size_t Rank>
concept blas_writable_mdspan =
    uni20::MutableRankedStridedMdspanLike<Mdspan, Rank> && blas_writable_device_mdspan<Mdspan, Rank>;
