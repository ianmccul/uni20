...
| Tensor/linalg CPU helper probes | yes | n/a | Current probes cover dispatched real one-norm evaluation, dense solve, tensor reductions, and matrix-exponential prescaling in binary128 over `uni20::DenseMatrix`. |
