                   ...
                   BlockSparseTwoSiteSweepObserver observer = {}) -> BlockSparseTwoSiteSweepOptions
{
  return BlockSparseTwoSiteSweepOptions{
      .lanczos = tensorcontraction::LanczosOptions{
          .max_iterations = static_cast<int>(terminal::getenv_or_default<long>("UNI20_HEISENBERG_LANCZOS_MAX_ITERS", 24)),
          .min_iterations = static_cast<int>(terminal::getenv_or_default<long>("UNI20_HEISENBERG_LANCZOS_MIN_ITERS", 2)),
          .tolerance = 1.0e-12},
