...
accessor-respecting CPU reference loop and direct no-copy BLAS lowering when the M, N, and K stride
groups each collapse to one GEMM dimension.  Looped GEMM and pack--GEMM--unpack remain backend
strategies rather than Tensor-front-end rewrites.  The canonical current contract is
