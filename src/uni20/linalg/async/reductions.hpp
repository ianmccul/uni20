...
template <AsyncTensorOutput OutputTensor, ImmediateTensorView InputTensor, std::size_t InputRank,
...
template <class BackendSelector, AsyncTensorOutput OutputTensor, ImmediateTensorView InputTensor, std::size_t InputRank,
          std::size_t ReducedRank>
...
template <class BackendSelector, ImmediateTensorView InputTensor>
...
template <linalg::KernelBackendSelector BackendSelector, detail::AsyncTensorOutput OutputTensor,
          ImmediateTensorView InputTensor>
  requires MutableScalarImmediateTensorView<OutputTensor> && RealOrComplex<tensor_element_t<InputTensor>> &&
...
{
  constexpr std::size_t input_rank = immediate_tensor_mdspan_t<InputTensor>::rank();
...
/// \pre The output must not share an epoch queue with the input.
template <detail::AsyncTensorOutput OutputTensor, ImmediateTensorView InputTensor>
  requires MutableScalarImmediateTensorView<OutputTensor> && RealOrComplex<tensor_element_t<InputTensor>> &&
           std::same_as<tensor_element_t<OutputTensor>, tensor_element_t<InputTensor>>
...
/// \pre The output must not share an epoch queue with the input.
template <linalg::KernelBackendSelector BackendSelector, detail::AsyncTensorOutput OutputTensor,
          ImmediateTensorView InputTensor, linalg::ReductionAxis FirstAxis, linalg::ReductionAxis... RestAxes>
  requires RealOrComplex<tensor_element_t<InputTensor>> &&
           std::same_as<tensor_element_t<OutputTensor>, tensor_element_t<InputTensor>> &&
           (1 + sizeof...(RestAxes) <= immediate_tensor_mdspan_t<InputTensor>::rank()) &&
           (mutable_immediate_tensor_mdspan_t<OutputTensor>::rank() + 1 + sizeof...(RestAxes) ==
            immediate_tensor_mdspan_t<InputTensor>::rank())
void sum(BackendSelector selector, async::Async<OutputTensor>& output, async::Async<InputTensor> const& input,
...
/// \pre The output must not share an epoch queue with the input.
template <detail::AsyncTensorOutput OutputTensor, ImmediateTensorView InputTensor, linalg::ReductionAxis FirstAxis,
...
template <linalg::KernelBackendSelector BackendSelector, ImmediateTensorView InputTensor>
  requires RealOrComplex<tensor_element_t<InputTensor>> &&
...
template <ImmediateTensorView InputTensor>
  requires RealOrComplex<tensor_element_t<InputTensor>> &&
           detail::ReductionResultAvailable<tensor_element_t<InputTensor>, InputTensor>
...
template <ImmediateTensorView InputTensor, linalg::ReductionAxis FirstAxis, linalg::ReductionAxis... RestAxes>
  requires RealOrComplex<tensor_element_t<InputTensor>> &&
           (1 + sizeof...(RestAxes) <= immediate_tensor_mdspan_t<InputTensor>::rank()) &&
           detail::ReductionResultAvailable<tensor_element_t<InputTensor>, InputTensor>
