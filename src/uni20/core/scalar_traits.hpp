...
/// \tparam T Type to inspect.
/// \ingroup core_math
template <typename T> inline constexpr bool is_integer_v = is_integer_t<std::remove_cvref_t<T>>::value;
...
/// \tparam T Type to inspect.
/// \ingroup core_math
template <typename T> inline constexpr bool is_complex_v = is_complex_t<std::remove_cvref_t<T>>::value;

/// \brief Trait to detect whether a type is a numeric scalar (real, complex, or integer).
/// \tparam T Type to inspect.
/// \ingroup core_math
template <typename T> inline constexpr bool is_scalar_v = is_real_v<T> || is_complex_v<T> || is_integer_v<T>;

/// \brief Trait to detect whether a type is a real or complex scalar.
/// \tparam T Type to inspect.
/// \ingroup core_math
template <typename T> inline constexpr bool is_real_or_complex_v = is_real_v<T> || is_complex_v<T>;
