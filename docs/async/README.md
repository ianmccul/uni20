...
| Supplemental (design/history) | `scheduler_migration.md`, `tensor_lifetime_and_dispatch_draft.md`, `audit_legacy_docs.md` | you need design rationale or migration context |
