...
- `docs/architecture/execution.md` — the design this exercise informed.
- `docs/symmetry/block_sparse_tensor.md`, `docs/symmetry/block_coalescing.md` — tensor + coalescing design.
- `docs/tensor_network/rabc_contraction_scheduling.md` — the R/A/B/C apply and its cost model.
- `docs/architecture/ordering_and_backend_lowering.md` — ordering ownership and lowering.
- `docs/tensor_network/rabc_lanczos_fixtures.md` — replay fixture format.
...
- Fixture format: `docs/tensor_network/rabc_lanczos_fixtures.md`.
