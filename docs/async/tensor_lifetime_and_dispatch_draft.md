...
[`../tensor/operations.md`](../tensor/operations.md). This draft retains the deeper
...
- [`storage.md`](storage.md) - `Async<T>` storage, value kinds, and
...
- [`../symmetry/block_tensor.md`](../symmetry/block_tensor.md) - block tensor structure and per-block
  storage policies.
- [`../symmetry/block_coalescing.md`](../symmetry/block_coalescing.md) - coalesced views over the same
...
rule from `../tensor/dispatch_and_view_semantics_draft.md`: allocation is chosen
