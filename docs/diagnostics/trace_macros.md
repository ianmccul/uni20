...
This guide documents the trace/assert macros in
`src/uni20/common/trace.hpp`, runtime formatting controls, and stacktrace
configuration.
...
For unit tests, there are GTest-oriented helpers in
`src/uni20/common/gtest.hpp`:
