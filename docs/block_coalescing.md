...
- `docs/block_sparse_tensor.md` — the tensor and layout this operates over.
- `docs/ordering_and_backend_lowering.md` — stream/event lowering; per-launch cost.
- `docs/execution_architecture.md` — coalescing as one use of the cost-model knob.
- `docs/backend_dispatch.md` — batched/coalesced kernels as backend capabilities.
- `docs/rabc_contraction_scheduling.md` — the R/A/B/C apply this most affects.
...
constants used for placement (see `execution_architecture.md` for the numbers).
