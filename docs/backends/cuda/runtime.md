...
**Status:** active design note over the current CUDA task/build scaffolding; it
does not describe a complete Tensor CUDA runtime.
...
The `GpuEpochQueue` design in `epoch_design_draft.md` uses
