...
Status: design note. This is intended to fix the core policy before Python bindings and higher-level tensor-network interfaces acquire accidental semantics. It complements the block-sparse tensor and symmetry design in [block_tensor.md](block_tensor.md).
